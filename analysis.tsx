  ...
  return (
    ...
    >
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        {/* Annotated Contact Frame - shows real pose tracking + grade on your actual swing */}
        {analysis.annotated_image_base64 && (
          <Animated.View entering={FadeIn.delay(100).duration(600)} style={styles.annotatedImageWrapper}>
            <Image
              source={{ uri: `data:image/jpeg;base64,${analysis.annotated_image_base64}` }}
        ...
        <Animated.View entering={FadeIn.delay(1600).duration(600)}>
          <Card style={styles.proCard}>
            <View style={styles.proHeader}>
              ...
              <Text style={styles.proTitle}>How This Was Scored</Text>
            </View>
...
const styles = StyleSheet.create({
  ...
  annotatedImageWrapper: { width: '100%', aspectRatio: 9 / 16, borderRadius: 20, overflow: 'hidden', marginBottom: SPACING.lg, backgroundColor: COLORS.secondary },
